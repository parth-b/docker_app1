...
class NetLs extends StatefulWidget {
  @override
  _NetLsState createState() => _NetLsState();
}

class _NetLsState extends State<NetLs> {
  var x, y;
  var data;
  web() async {
    var res = await http.get('http://192.168.29.160/cgi-bin/netls.py');
    var sol = res.body;
