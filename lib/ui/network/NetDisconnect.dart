...
class NetDisconnect extends StatefulWidget {
  @override
  _NetDisconnectState createState() => _NetDisconnectState();
}

class _NetDisconnectState extends State<NetDisconnect> {
  var x, y;
  var data;
  web(x, y) async {
    var res = await http
        .get('http://192.168.29.160/cgi-bin/netdisconnect.py?x=$x&y=$y');
    var sol = res.body;
