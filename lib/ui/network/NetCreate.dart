...
class NetCreate extends StatefulWidget {
  @override
  _NetCreateState createState() => _NetCreateState();
}

class _NetCreateState extends State<NetCreate> {

 var x, y;
  var data;
  web(x, y) async {
    var res = await http.get(
        'http://192.168.29.160/cgi-bin/netcreate.py?x=$x&y=$y');
    var sol = res.body;
                      ...
                      Padding(
                        ...
                        child: Card(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              hintText: "Enter the name of driver",
                              filled: true,
